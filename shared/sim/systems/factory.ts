...
/** Seconds a miner takes to extract one ore. The renderer reads it too. */
...
function stepCrafter(
  ...
  const duration = craftTime(recipe, def.speed * bonus.crafting);

...
- [ ] On desktop at 1280x800 the build palette stays open over most of the
      screen while placing, so there is little ground left to click on. Picking
      a piece could fold the palette down to a strip.
